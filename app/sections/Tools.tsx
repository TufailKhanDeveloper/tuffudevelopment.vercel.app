...
import {
    ...
    SiAdobeillustrator,
    SiAdobephotoshop, SiAngular, SiAngularjs, SiAstro, SiAwsamplify, SiBlockchaindotcom, SiCanva, SiChainlink, SiCinema4D, SiCplusplus, SiDjango, SiFigma, SiFramer, SiGit,
    SiGithub,
    SiGo,
    SiGooglechrome, SiGooglefonts,
    SiIntellijidea, SiJavascript, SiKotlin, SiLua,
    SiMongodb,
    SiNeovim, SiNetlify, SiNextdotjs, SiNodedotjs, SiPython, SiReact, SiRust, SiServerfault, SiServerless, SiSolid, SiSolidity, SiTypescript, SiVercel, SiVisualstudio, SiVuedotjs, SiWeb3Dotjs, SiWebstorm, SiZig
} from "react-icons/si";
        ...
        >
            <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
                ...
                <div className="mx-auto w-[100%] lg:max-w-[1200px] justify-center">
                    ...
                    <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-bold leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[40px] md:leading-relaxed lg:mb-16 lg:w-[50%]">
                        <AnimatedBody delay={0.4} text="Server Side" />
                        <div>
